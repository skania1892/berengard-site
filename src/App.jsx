...
import Logo from './assets/Logo1_centered-update1.png';

export default function App() {
  return (
    <div className="relative min-h-screen text-slate-800">
      {/* Background image layer (fixed, faint, non-interactive) */}
      <div
        className="fixed inset-0 bg-no-repeat bg-cover bg-center opacity-10 pointer-events-none z-0"
